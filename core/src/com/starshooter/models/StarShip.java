...
public abstract class StarShip extends Sprite {
	...
	public static final Color FADE = new Color(1f, 1f, 1f, 0f);
	protected Color modulation;
	...
	protected void update(float delta) {
		float r = getColor().r +  modulationSpeed * (getModulation().r  - getColor().r);
		float g = getColor().g +  modulationSpeed * (getModulation().g - getColor().g);
		float b = getColor().b +  modulationSpeed * (getModulation().b - getColor().b);
		float a = getColor().a +  modulationSpeed * (getModulation().a - getColor().a);
		setColor(r, g, b, a);
	}
	
	protected Color getModulation() {
		return modulation;
	}
